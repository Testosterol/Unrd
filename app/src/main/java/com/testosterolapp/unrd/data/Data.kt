...
class Data {
    ...
    constructor(id_fk_events: Long?, chat_message_id: Long?, chat_id: Long?,
                character_id: Long?, media_duration: Long?, content: String?,
                url_label: String?, sequence: Long?, price: Long?, is_locked: Boolean?,
                has_options: Boolean?, options_timeout: Long?, created: String?, updated: String?,
                has_url: Boolean?, resource_id: Long?, thumb_resource_id: Long?, owned: Boolean?) {
